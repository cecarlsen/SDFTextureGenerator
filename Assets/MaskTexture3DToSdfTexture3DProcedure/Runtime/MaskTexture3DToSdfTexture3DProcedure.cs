...
public class MaskTexture3DToSdfTexture3DProcedure
{
	...
	public MaskTexture3DToSdfTexture3DProcedure()
	{
		_computeShader = Object.Instantiate( Resources.Load<ComputeShader>( nameof( MaskTexture3DToSdfTexture3DProcedure ) ) );

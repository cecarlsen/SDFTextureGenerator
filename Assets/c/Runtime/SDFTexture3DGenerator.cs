...
public class SDFTexture3DGenerator
{
	...
	public SDFTexture3DGenerator()
	{
		_computeShader = Object.Instantiate( Resources.Load<ComputeShader>( nameof( SDFTexture3DGenerator ) + "Compute" ) );

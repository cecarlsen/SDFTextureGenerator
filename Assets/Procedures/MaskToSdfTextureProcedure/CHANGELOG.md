...
## [1.1.0] - 2026-02-12
	...
	- Added prioritizeMemoryUsageOverSpeed option. When enabled, uses 16-bit float format for internal flood texture (64-bit total) instead of 32-bit (128-bit total), reducing memory usage at the cost of potential R/W performance.
